...
Dieselbe Leseordnung für GitHub Copilot: `.github/copilot-instructions.md` (dort auch die Herkunft
aus dem früheren Copilot-Memory-Seed `memory/repo/`, überführt 2026-09-11).
